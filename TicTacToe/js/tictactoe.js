...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            //If active player is 'X' changeit to 'O'.
            activePlayer = 'O';
...
function checkWinConditions() {
    ...
    // O 0, 3, 6 condition.
    else if (arrayIncludes('0O', '3O', '6O')) { drawWinLine(10, 50, 100, 558) }
    // O 1, 4, 7 condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        x = x1,
        //This variable stores temporary y axis data we updated in our animation loop.
        y = y1;
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (x < x2) { x += 10; }
            //This  condition adds 1- to the previouse end y endpoint.
            if (y < y2) { y += 10; } 
            //This condition is similar to the one above.
            //This is necessary for the 6, 4, 2 win condittions.
            if (x >= x2 && y >= y2) { cancelAnimationFrameAnimationFram(animationLoop); }
        }
        //This condition is similar to the one above.
