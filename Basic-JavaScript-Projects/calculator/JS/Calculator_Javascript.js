...
const Calculator = {
    ...
    //This will hold the oprator, we set it to null for now.
    operator: null,
};
...
function Handle_Operator(Next_Operator) {
    ...
    //Calulator.Frist_Operand if it dosen't already exist.
    const Value_of_Input = parseFloat(Display_Value);
    //Checks if an operator already exists and if Wait_Second_Operand is true,
    //then updates the oprator an exits from the function.
...
function Update_Display() {
    //Makes use of the calculator-screeen class to target the
...
Update_Display();
//This sction monitors button clicks
